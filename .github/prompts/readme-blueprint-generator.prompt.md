---
description: '智慧型 README.md 產生提示，可分析專案文件結構並建立全面的程式碼庫文件。掃描 .github/copilot 目錄文件和 copilot-instructions.md 文件，提取專案資訊、技術堆疊、架構、開發流程、編碼標準和測試方法，同時生成結構良好、格式規範、交叉引用且內容以開發者為中心的 Markdown 。'
